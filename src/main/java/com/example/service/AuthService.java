...
//
//
//        Optional<ProfileEntity> optionalProfile = profileRepository.findByPhoneAndPassword(dto.getPhone(), dto.getPassword());
//
...
//            throw new AuthorizationFailedException("Wrong status. Please connect with admin.");
//
